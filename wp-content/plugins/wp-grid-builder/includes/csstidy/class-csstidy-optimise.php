...
class csstidy_optimise {
		...
		if ($this->parser->get_cfg('optimise_shorthands') > 0) {
			foreach ($this->css as $medium => $value) {
				foreach ($value as $selector => $value1) {
					...
					// Too much issue when merging background properties.
	...
	public function dissolve_short_font($str_value) {
		...
		$important = '';
		$return = ['font-style' => null, 'font-variant' => null, 'font-weight' => null, 'font-size' => null, 'line-height' => null, 'font-family' => null];
