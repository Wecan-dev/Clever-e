          ...
          <li class="nav-item nav-responsive">
              ...
              <ul class="navbar-nav mr-autos">
                <li class="nav-item dropdown drop-money">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item woocs_flag_view_item" href="?_amc-currency=USD" data-currency="USD" title="USD, $ USA dollar">USD, $</a>
                    <a href="?_amc-currency=COP" class="dropdown-item woocs_flag_view_item" data-currency="COP" title="COP, $ Peso Colombiano">COP, $</a>
                  </div>
                </li>
              </ul>  
              ...
              <div class="content-icon">
                ...
                <ul class="navbar-nav mr-autos">
                  <li class="nav-item dropdown drop-money">
                    <a aria-expanded="false" aria-haspopup="true" class="nav-world nav-link dropdown-toggle" data-toggle="dropdown" href="catalogo.html" role="button"><img src="<?php echo get_template_directory_uri();?>/assets/img/world.png"></a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item woocs_flag_view_item" href="?_amc-currency=COP" data-currency="USD" title="USD, $ USA dollar">USD, $</a>
                      <a href="?_amc-currency=COP" class="dropdown-item woocs_flag_view_item" data-currency="COP" title="COP, $ Peso Colombiano">COP, $</a>
                    </div>
                  </li>
                </ul>
