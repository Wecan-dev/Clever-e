...
<?php endif; ?>
    ...
    <?php if ($_GET["create"] != 'account') { ?>
		<form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <br>
            <p class="form-row flex-login or"><span class="or-space">OR</span></p>          
...
<?php if ($_GET["create"] == 'account') { ?>
	...
	<div class="u-column2 col-12">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
            ...
            <br>
            <p class="form-row flex-login or"><span class="or-space">OR</span></p>          
            <p class="woocommerce-in-account"><a href="?create=">Back to login <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shop/arrow.png" class=" b-error"></a></p>
