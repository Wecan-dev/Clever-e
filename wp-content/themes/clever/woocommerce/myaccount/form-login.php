...
<h2>Iniciar Sesión</h2>
			...
			<p class="form-row">
				...
				<button type="submit" class="main-general__button woocommerce-button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</p>
			<div class="form-login__register" >
				<p class="woocommerce-LostPassword lost_password">
					<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'woocommerce' ); ?></a>
					<p class="woocommerce-in-account"><a href="?create=account">Create an account</a></p>
				</p>
			</div>
...
<?php if ($_GET["create"] == 'account') { ?>
	...
	<div class="u-column2 col-12 flex-login">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register form-custom register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
		<div class="login-img">
...
<h2>Registrarse</h2>
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit" class="woocommerce-Button main-general__button woocommerce-button  woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>

            <br>
            <p class="woocommerce-in-account"><a href="?create=">Back to login</a></p>
